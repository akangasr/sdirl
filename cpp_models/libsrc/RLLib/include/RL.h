...
namespace RLLib
{
  ...
  class RLProblem
  {
    ...
    public:
      ...
      {
        updateTRStep();
        this->output->updateTRStep(this->r(), this->z(), this->endOfEpisode());
      }
      ...
      virtual void draw(const int& outputType) const
      {/*To output useful information*/
      }

      virtual Actions<T>* getDiscreteActions() const
      {
        return this->discreteActions;
      }

      virtual Actions<T>* getContinuousActions() const
      {
        return this->continuousActions;
      }
  ...
  class RLRunner
  {
    ...
    public:
      ...
      RLRunner(RLAgent<T>* agent, RLProblem<T>* problem, const int& maxEpisodeTimeSteps,
          ...
          , problem(problem)
          , agentAction(0)
          , maxEpisodeTimeSteps(maxEpisodeTimeSteps)
          ...
          , enableLog(false)
          , outputType(0)
          , enableTestEpisodesAfterEachRun(false)
          , maxTestEpisodesAfterEachRun(20)
          , timeStep(0)
          , episodeR(0)
          , episodeZ(0)
      {
      ...
      void setEnableLog(const bool& enableLog)
      {
        this->enableLog = enableLog;
      }

      void setOutputType(const int& outputType)
      {
